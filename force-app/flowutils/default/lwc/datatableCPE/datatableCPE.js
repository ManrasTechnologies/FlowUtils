...
import getCPEReturnResults from '@salesforce/apex/DatatableController.getCPEReturnResults';
import { getConstants } from 'c/datatableUtils';

const CONSTANTS = getConstants();   // From datatableUtils : VERSION_NUMBER, MAXROWCOUNT, ROUNDWIDTH, MYDOMAIN, ISCOMMUNITY, WIZROWCOUNT
...
export default class datatableCPE extends LightningElement {
    ...
    // Define any banner overrides you want to use (see flowBanner.js)
