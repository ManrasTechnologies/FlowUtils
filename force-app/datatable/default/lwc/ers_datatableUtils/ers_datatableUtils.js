...
const getConstants = () => {
    return {
        ...
        CB_TRUE : 'CB_TRUE',        // Used with flowCheckbox component
        CB_FALSE : 'CB_FALSE',      // Used with flowCheckbox component
        CB_ATTRIB_PREFIX : 'cb_',   // Used with flowCheckbox component
    }
}
