...
import deployMetadata from '@salesforce/apex/usf.DeployMetadata.deploy';
...
export default class TransferMetadata extends LightningElement {
    ...
    deploy() {
        ...
        deployMetadata({ metadataText : documentContent, metadataName : this.modifiedName, testLevel: null, objectType : this.objectType,  })        
        .then(result => {
